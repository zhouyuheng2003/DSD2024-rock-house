...
1. All the InterfaceId and CurrentUser from Web part have been removed. Though this may bring some nonalignment in IS formulation, we have reached agreement between web and database group.
